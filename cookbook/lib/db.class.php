...
class DB {
  // initial connection
  public static $dbName = 'cookbook';
  public static $user = 'root'; //localhost MAMP default "root"
  public static $password = 'root'; //localhost MAMP default empty / "root"
  public static $host = 'localhost';
  public static $port = 8889; //default = 3306, MAMP = 8889
